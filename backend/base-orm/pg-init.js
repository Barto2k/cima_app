...
// Configuración de Sequelize para PostgreSQL usando variable de entorno
const sequelize = process.env.DATABASE_URL 
  ? new Sequelize(process.env.DATABASE_URL, {
      ...
      dialectOptions: {
        ssl: {
          require: true,
          rejectUnauthorized: false // Necesario para conexiones SSL de Render
        }
      },
      logging: false // Puedes activar esto para depuración
    })
  : new Sequelize("sqlite:" + "./.data/CIMA.db"); // Fallback a SQLite para desarrollo local
...
const usuarios = sequelize.define(
  "usuarios",
  {
    ...
    Nombre: {
      ...
      allowNull: false,
      unique: true, // Asegura que sea único como en tu esquema SQLite
      validate: {
        notEmpty: {
          args: true,
...
const pacientes = sequelize.define(
  "pacientes",
  {
    ...
    Nombre: {
      ...
      allowNull: true, // En el SQLite original no era NOT NULL
    },
    Apellido: {
      type: DataTypes.STRING(60),
      allowNull: true, // En el SQLite original no era NOT NULL
...
// Ejecutar la función para crear la base si no existe
CrearBaseSiNoExiste();
